...
void sonMenu2(BinarySortTreePtr bst);
void sonMenu3(BinarySortTreePtr bst);
void sonMenu4(BinarySortTreePtr bst);
void sonMenu5(BinarySortTreePtr bst);
